          ...
          <div class="widgets-container desktop-padding-left" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="recent-posts-widget widget-item">
              ...
              <?php if (!empty($recent_posts)): ?>
                  ...
                  <div class="post-item">
                    <img src="<?php echo BASE_URL; ?>/<?php echo htmlspecialchars($post['main_image']); ?>" alt="" class="flex-shrink-0" style="box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.2);">
                    <div>
                      <h4><a href="/web_site/blog_details.php?id=<?php echo htmlspecialchars($post['id_post']); ?>"><?php echo htmlspecialchars($post['title']); ?></a></h4>
