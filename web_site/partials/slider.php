...
<div class="slideshow-container">
    ...
    <div class="mySlides fade">
        <a href="/web_petrodrill/web_site/blog_details.php?id=<?php echo $slide['id_post']; ?>">
            <img src="<?php echo BASE_URL; ?>/public/uploads/attachments/<?php echo htmlspecialchars($slide['image_path']); ?>" alt="<?php echo htmlspecialchars($slide['title']); ?>">
        </a>
    </div>
    <?php endforeach; ?>
